...
class StructureServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = resource_path('views/modules/structure');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/structure';
        }, \Config::get('view.paths')), [$sourcePath]), 'structure');
    }
    ...
    {
        $langPath = resource_path('lang/modules/structure');
