          ...
          <b-table show-empty
           ...
           >
            ...
            <template slot="actions" slot-scope="row">
                <!-- We use @click.stop here to prevent a 'row-clicked' event from also happening -->
                <b-button :href="'/crm/settings/editfield?q='+row.item.id+'&model='+vimodels" class="btn-warning" size="sm" @click.stop="editRow(row.item.id)" >
                   Редактировать
                </b-button>
